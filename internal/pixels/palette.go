...
var Vice = createPalette(
	color.Palette{
		...
		color.RGBA{R: 0xbc, G: 0x52, B: 0x41, A: 0xff},
		color.RGBA{R: 0x8f, G: 0xef, B: 0xfb, A: 0xff},
		color.RGBA{R: 0xb9, G: 0x56, B: 0xeb, A: 0xff},
		color.RGBA{R: 0x7e, G: 0xdb, B: 0x40, A: 0xff},
		color.RGBA{R: 0x55, G: 0x3f, B: 0xe4, A: 0xff},
		color.RGBA{R: 0xff, G: 0xff, B: 0x77, A: 0xff},
		color.RGBA{R: 0xc1, G: 0x7b, B: 0x1d, A: 0xff},
		color.RGBA{R: 0x82, G: 0x63, A: 0xff},
		color.RGBA{R: 0xf4, G: 0x94, B: 0x86, A: 0xff},
		color.RGBA{R: 0x72, G: 0x72, B: 0x72, A: 0xff},
		color.RGBA{R: 0xa4, G: 0xa4, B: 0xa4, A: 0xff},
		color.RGBA{R: 0xcd, G: 0xff, B: 0x98, A: 0xff},
		color.RGBA{R: 0x9e, G: 0x8d, B: 0xff, A: 0xff},
		color.RGBA{R: 0xd5, G: 0xd5, B: 0xd5, A: 0xff},
	})
